...
exports.formatErrorWithSuggestion = exports.getSuggestion = void 0;
/**
 * Generate actionable suggestion based on error and action context
 */
const getSuggestion = (error, actionType) => {
 ...
 */
const formatErrorWithSuggestion = (error, actionType) => {
    const { suggestion } = (0, exports.getSuggestion)(error, actionType);
    return `${error.message}\n\n💡 Suggestion: ${suggestion}`;
};
exports.formatErrorWithSuggestion = formatErrorWithSuggestion;
exports.default = { getSuggestion: exports.getSuggestion, formatErrorWithSuggestion: exports.formatErrorWithSuggestion };
