...
export const env = {
  ...
  NOTION_REDIRECT_URI: process.env.NOTION_REDIRECT_URI || "https://axle-api-q8oa.onrender.com/api/v1/oauth/notion/callback",
  ...
  POLAR_CUSTOM_PRODUCT_ID: process.env.POLAR_CUSTOM_PRODUCT_ID!,
  // Polar credit packages
  ...
  POLAR_CREDITS_5000_PRODUCT_ID: process.env.POLAR_CREDITS_5000_PRODUCT_ID || "",
  // Pinecone vector database
  PINECONE_API_KEY: process.env.PINECONE_API_KEY!,
  PINECONE_MEMORY_INDEX: process.env.PINECONE_MEMORY_INDEX!,
  PINECONE_RAG_INDEX: process.env.PINECONE_RAG_INDEX!,
};
